create database new_student_enrollment_project;
use new_student_enrollment_project;
...
create table instructor (
  ...
  branches varchar(50) ,
  constraint fk_branches FOREIGN KEY(branches) REFERENCES course(branches)
);
